...
export const DB = [
  ...
  {cat:"Sales",name:"Rozaana Field Order Dashboard",
   pc:"Ms. Richa",solver:"Mr. Pranav",exec:"Sales Team",links:{dash:1,sheet:1}},
  ...
  {cat:"Sales",name:"Double A Distributor Visit",subcat:"Double A",
  ...
  {cat:"Sales",name:"Double A New Distributor Form",subcat:"Double A",
   pc:"Ms. Richa",solver:"Mr. Pranav",exec:"Mr. Mukesh",links:{form:1,sheet:1,terms:1,drive:1,guidelineForm:1,aiqa:1}},
  {cat:"Sales",name:"Double A District Distributor",subcat:"Double A",
   pc:"Ms. Richa",solver:"Mr. Pranav",exec:"Mr. Mukesh",links:{sheet:1}},
  {cat:"Sales",name:"Double A CME Payment FMS FY 2026-27",subcat:"Double A",
   pc:"Ms. Richa",solver:"Mr. Pranav/Mr. Mukesh",exec:"Sales Team",links:{fms:1,gasForm:1,aiqa:1}},
  {cat:"Sales",name:"Double A Dealer",subcat:"Double A",
   pc:"Ms. Richa",solver:"Mr. Pranav",exec:"Mr. Mukesh",links:{sheet:1}},
  {cat:"Sales",name:"Double A CME Folder",subcat:"Double A",
   pc:"Ms. Richa",solver:"Mr. Pranav",exec:"Mr. Mukesh",links:{folder:1,calc:1}},
  {cat:"Sales",name:"Double A Retail Customer (Mr. Rishabh)",subcat:"Double A",
   pc:"Ms. Richa",solver:"Mr. Pranav",exec:"Mr. Mukesh",links:{sheet:1,guidelineForm:1,stockDash:1}},
  {cat:"Sales",name:"Double A Corporate Customer",subcat:"Double A",
   pc:"Ms. Richa",solver:"Mr. Pranav",exec:"Mr. Mukesh",links:{sheet:1,form:1}},
  {cat:"Sales",name:"Double A Container Tracker",subcat:"Double A",
   pc:"Ms. Richa",solver:"Mr. Pranav",exec:"Mr. Mukesh",links:{dash:1}},
  {cat:"Sales",name:"Double A Display Links",subcat:"Double A",
   pc:"Ms. Richa",solver:"Mr. Pranav",exec:"Sales Team",links:{folder:1,followup:1,incentive:1,form:1}},
  {cat:"Sales",name:"Double A Display FMS",subcat:"Double A",
   pc:"-",solver:"-",exec:"-",links:{daDisplayFms:1,daDisplayDash:1}},
  // ──────────────────────────────────────────────────────────────
  ...
  {cat:"Sales",name:"Ruchira Color Copier Client (Mr. Pawan)",
   pc:"Ms. Richa",solver:"Mr. Pranav/Mr. Mukesh",exec:"Sales Team",links:{sheet:1,stockDash:1,aiqa:1}},
  ...
  {cat:"Purchase",name:"New Purchase FMS",
   pc:"-",solver:"-",exec:"-",links:{fms:1,sheet:1}},
  ...
  {cat:"AdminMIS",name:"New Checklist",
   pc:"-",solver:"-",exec:"-",links:{check:1,sheet:1}},
  {cat:"AdminMIS",name:"Office Desk",
   pc:"-",solver:"-",exec:"-",links:{dash:1,sheet:1}},
...
export const LINK_META = {
  ...
  orderFormPdf:      {label:'PDF',       icon:'fas fa-file-pdf',   cls:'btn-form',
               url:'https://drive.google.com/file/d/1EYrIFWS5OCk_laSsty1HJHKiTKy6ggtR/view?usp=drive_link'},
  ...
  truckOrderFormPdf: {label:'PDF',       icon:'fas fa-file-pdf',   cls:'btn-form',
               url:'https://drive.google.com/file/d/1VXcPWEn9S3HK9ugBrMzsf--33gvXGdkn/view?usp=drive_link'},
