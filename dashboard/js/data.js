...
export const DB = [
  // -------- SALES --------
  {cat:"Dispatch",name:"Order to Delivery FMS",pc:"Ms. Richa",solver:"Mukesh",exec:"Khushi",links:{fms:1,gasForm:1,videoBCI:1,videoAI:1,aiqa:1}},
  ...
  {cat:"Sales",name:"Next Week/ Day Marketing Plan",pc:"Ms. Richa",solver:"Mr. Pranav/Mr. Mukesh",exec:"Sale's Team",links:{gasForm:1,sheet:1,aiqa:1}},
  {cat:"Sales",name:"New Customer Visit",pc:"Neha",solver:"Neha / Pranav",exec:"Sonu, Pawan, Rishabh",links:{form:1,sheet:1,aiqa:1}},
  {cat:"Sales",name:"Enquiry Capture FY 2026-27",pc:"Ms. Richa",solver:"Mr. Pranav/Mr. Mukesh",exec:"Ms. Neha",links:{gasForm:1,sheet:1,aiqa:1}},
  ...
  {cat:"Sales",group:"Double A",name:"Double A Advance Container Booking Form",pc:"Ms. Richa",solver:"Mr. Pranav",exec:"Mr. Rishabh",links:{gasForm:1,sheet:1,aiqa:1}},
  ...
  {cat:"Sales",group:"Double A",name:"Double A CME Payment FMS FY 2026-27",pc:"Ms. Richa",solver:"Mr. Mukesh",exec:"Mr. Indresh/Sandeep/Mukesh/Ms. Richa",links:{fms:1,gasForm:1,aiqa:1}},
  ...
  // -------- PURCHASE --------
  {cat:"Purchase",name:"Purchase FMS",pc:"Ms. Richa",solver:"Neha / Pranav",exec:"Khushi",links:{fms:1,gasForm:1,video:1,videoBCI:1}},
  {cat:"Purchase",name:"IMS (Inventory System)",pc:"Ms. Neha",solver:"Mukesh / Pranav",exec:"Khushi",links:{form:1,sheet:1,video:1}},
  {cat:"Purchase",name:"WMS",pc:"Ms. Neha",solver:"Mr. Mukesh",exec:"Ms. Richa/Ms. Khushi",links:{gasForm:1,sheet:1}},
  {cat:"Purchase",name:"Godown Stock Report",pc:"Ms. Neha",solver:"Mr. Mukesh",exec:"Ms. Richa/Ms. Khushi",links:{gasForm:1,sheet:1}},
  {cat:"Purchase",name:"Godown Inward Report",pc:"Ms. Neha",solver:"Mr. Mukesh",exec:"Ms. Richa/Ms. Khushi",links:{sheet:1}},
  {cat:"Purchase",name:"Stock Transfer FMS",pc:"Ms. Richa",solver:"Mr. Mukesh",exec:"Mr. Indresh/Sandeep/Ms. Pooja",links:{fms:1,gasForm:1}},
  {cat:"Purchase",name:"Shop Stock Report",pc:"Ms. Richa",solver:"Mr. Mukesh",exec:"Mr. Indresh/Sandeep/Ms. Pooja",links:{gasForm:1,sheet:1}},
  ...
  {cat:"Management",name:"Delegation Sheet",pc:"Ms. Neha",solver:"Neha / Pranav",exec:"Neha",links:{gasForm:1,sheet:1,video:1}},
  ...
  {cat:"Finance",name:"Sales Marketing Daily Expense",pc:"Ms. Richa",solver:"Ms. Neha",exec:"Sale's Team",links:{gasForm:1,sheet:1}},
