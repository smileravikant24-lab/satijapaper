...
const BANK_DETAILS = [
  ...
  { id:'yes_bank',      group:'personal', groupLabel:'Personal', order:5,
    ...
    hasQR:false },
  { id:'pnb_pranav',    group:'personal', groupLabel:'Personal', order:6,
    bankName:'Punjab National Bank',  holderName:'PRANAV SATIJA',
    accountNo:'1524000101127378',     bank:'Punjab National Bank',
    branch:'Dr Mukherjee Nagar',      ifsc:'PUNB0498800',
    accountType:'Saving',             hasQR:false },
  { id:'pnb_pranav_ppf',group:'personal', groupLabel:'Personal', order:7,
    bankName:'Punjab National Bank',  holderName:'PRANAV SATIJA',
    accountNo:'099100PPF00000002080', bank:'Punjab National Bank',
    branch:'Dr Mukherjee Nagar',      ifsc:'PUNB0498800',
    accountType:'PPF',                hasQR:false },
  { id:'pnb_joint_all', group:'personal', groupLabel:'Personal', order:8,
    bankName:'Punjab National Bank',  holderName:'PRANAV SATIJA / SILKY GROVER / VEENA SATIJA',
    accountNo:'4988000100022424',     bank:'Punjab National Bank',
    branch:'Dr Mukherjee Nagar',      ifsc:'PUNB0498800',
    accountType:'Joint',              hasQR:false },
  { id:'kotak_joint',   group:'personal', groupLabel:'Personal', order:9,
    bankName:'Kotak Mahindra Bank',   holderName:'PRANAV SATIJA / SILKY GROVER',
    accountNo:'8649993547',           bank:'Kotak Mahindra Bank',
    branch:'B-1, Model Town, Gujranwala Town', ifsc:'KKBK0000185',
    accountType:'Joint',              hasQR:false },
];
